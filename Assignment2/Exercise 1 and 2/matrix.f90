...
program exc2
    use debugger
    implicit none 
    INTEGER :: bin_glob, dlevel, n_mat1, m_mat1, n_mat2, m_mat2, i, j, k
    ...
    timediff3 = dtime( timearray3 )
    print *, 'End result of matrix multiplication by do do do columnwise loop is:(time for computation was', timediff3, 'seconds)'
    print *, '------------------------------------------------'
